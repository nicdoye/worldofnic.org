...
```bash
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get svc worldofnic-svc
NAME             CLUSTER-IP     EXTERNAL-IP     PORT(S)          AGE
worldofnic-svc   10.3.251.146   146.148.26.37   80/TCP,443/TCP   9m
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get svc kubernetes
NAME         CLUSTER-IP   EXTERNAL-IP   PORT(S)   AGE
kubernetes   10.3.240.1   <none>        443/TCP   1h
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get po
NAME                  READY     STATUS    RESTARTS   AGE
worldofnic-rc-2ivdl   1/1       Running   0          9m
worldofnic-rc-x5tav   1/1       Running   0          9m
worldofnic-rc-y44ak   1/1       Running   0          9m
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get rc
NAME            DESIRED   CURRENT   AGE
worldofnic-rc   3         3         9m
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get no
NAME                                                      STATUS    AGE
...
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get ns
NAME          STATUS    AGE
default       Active    1h
kube-system   Active    1h
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get ep
NAME             ENDPOINTS                                         AGE
kubernetes       130.211.89.196:443                                1h
worldofnic-svc   10.0.0.4:80,10.0.1.5:80,10.0.2.4:80 + 3 more...   11m
snagglepuss:jekyll-www.worldofnic.org nic$ kubectl get cs
